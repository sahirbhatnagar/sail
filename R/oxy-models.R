...
#' @param type.measure PARAM_DESCRIPTION, Default: c("mse", "deviance", "class", "auc", "mae")
#' @param nfolds PARAM_DESCRIPTION, Default: 10
#' @param foldid PARAM_DESCRIPTION
#' @param grouped PARAM_DESCRIPTION, Default: TRUE
#' @param keep PARAM_DESCRIPTION, Default: FALSE
