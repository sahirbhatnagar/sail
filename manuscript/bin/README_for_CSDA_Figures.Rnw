...
<<setup2, include=FALSE, eval=TRUE>>=
library(knitr)
library(rmarkdown)
library(here)
library(fs)
knitr::opts_chunk$set(
  cache=TRUE, message = FALSE, tidy = FALSE, echo = FALSE,
  fig.width = 8,
  fig.height = 8,
  # fig.asp = 0.618,
  warning = FALSE,
...
knitr::read_chunk(here::here("manuscript","bin/intro.R"))
knitr::read_chunk(here::here("manuscript","bin/simulation.R"))
knitr::read_chunk(here::here("manuscript","bin/ADNI.R"))
knitr::read_chunk(here::here("manuscript","bin/support_plots.R"))
knitr::read_chunk(here::here("manuscript","bin/PRS_plots.R"))
#finalversion <- FALSE # set to FALSE if still in development and you dont want to run the R code
finalversion <- TRUE
@

<<packages, eval=finalversion>>=
# this is from setup.R
@
...
<<>>=
dir_tree(here::here("manuscript/bin"))
@
