...
source("PRS_model_functions.R")
source("PRS_method_functions.R")
source("PRS_eval_functions.R")
source("PRS_plot_functions.R")
...
save(simulation_results_PRS, sail_coef_list_PRS, file = "../results/PRS_results.RData")
# ls()
