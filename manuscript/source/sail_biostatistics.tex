...
\textit{Keywords}: Variable selection, Gene-environment interaction, Penalized regression, High-dimensional data, Hierarchical interaction, Blockwise coordinate descent
