...
<<toy-solution-path, fig.cap="Toy example solution path", fig.asp=0.8, eval = FALSE>>=
@

<<toy-effects, fig.cap="Estimated smooth functions by \\texttt{sail} method based on $\\lambda_{min}$.", eval = FALSE>>=
@
...
<<simulation-results, dev="cairo_pdf", fig.asp=1, fig.width=8, fig.heigh=11, fig.pos = 'H'>>=
@
