...
We compare the above listed methods with our main proposal \texttt{sail}, as well as \texttt{adaptive sail}, \texttt{sail weak} which has the weak heredity property and \texttt{linear sail}. 
