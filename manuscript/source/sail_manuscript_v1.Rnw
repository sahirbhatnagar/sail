...
<<plot-inter-adni, fig.asp=1, fig.width=10, fig.heigh=7, fig.pos = 'H', fig.cap="Estimated interaction effects by \texttt{sail} for ADNI data.", eval=T>>=
@


<<error-crosses-adni, fig.asp=1, fig.width=9, fig.heigh=7, fig.pos = 'H', fig.cap="Estimated interaction effects by \texttt{sail} for ADNI data.", eval=T>>=
@
