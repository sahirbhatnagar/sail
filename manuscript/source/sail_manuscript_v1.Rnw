...
<<toy-example, eval = TRUE>>=
@

<<toy-solution-path, fig.cap="Toy example solution path", fig.asp=0.8, eval = TRUE>>=
@

<<toy-effects, eval = TRUE, fig.cap="Estimated smooth functions by \\texttt{sail} method based on $\\lambda_{min}$.">>=
@
