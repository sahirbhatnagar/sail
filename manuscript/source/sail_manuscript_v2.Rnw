...
<<PRS-error-crosses-plots, fig.width=10, fig.height=8, fig.pos= 'H', fig.cap="Mean test set AUC vs. mean number of active variables ($\\pm 1$ SD) for the SUPPORT data based on 200 train/validation/test splits.", eval=finalversion>>=
@
...
<<support-error-cross, fig.width=10, fig.height=8, fig.pos= 'H', fig.cap="Mean test set AUC vs. mean number of active variables ($\\pm 1$ SD) for the SUPPORT data based on 200 train/validation/test splits.", eval=finalversion>>=
@
