...
<<error-crosses-adni, fig.width=10, fig.height=8, fig.pos = 'H', fig.cap="Mean test set MSE vs. mean number of active variables ($\\pm 1$ SD).", eval=finalversion>>=
@
...
<<fig.height=7, fig.width=8,echo=T,eval=finalversion>>=
