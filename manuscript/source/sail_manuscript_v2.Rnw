...
\subsection{Gene-environment interactions}
...
The Stanford Binet IQ scores at 4 years of age were collected for 188 subjects born to women randomly assigned to control ($n$ = 99) or nurse-visited intervention groups ($n$ = 89). 
...
We applied the weak heredity \sail ~with default settings to this data and selected the optimal tuning parameter using 10-fold cross-validation. 
...
\texttt{sail weak}  &  \Sexpr{round(affect.mat2[5,"mean"],1)} (\Sexpr{round(affect.mat2[5,"sd"],1)})     &  \Sexpr{round(affect.mat2[10,"mean"],0)} (\Sexpr{round(affect.mat2[10,"sd"],0)}) & & \Sexpr{round(errorSummary[5,"mean"],2)} (\Sexpr{round(errorSummary[5,"sd"],3)})     &  \Sexpr{round(errorSummary[10,"mean"],0)} (\Sexpr{round(errorSummary[10,"sd"],0)})  \NN
...
\texttt{GLinternet} &  	--                                                                               & --                                                                               & &  \Sexpr{round(errorSummary[1,"mean"],2)} (\Sexpr{round(errorSummary[1,"sd"],3)})     &  \Sexpr{round(errorSummary[6,"mean"],0)} (\Sexpr{round(errorSummary[6,"sd"],0)})   \LL
}
