...
\caption[Test set MSE results]{Test set MSE results.}\label{fig:plot-mse-sim}
\end{figure}
...
\caption[True positive rate vs]{True positive rate vs. false positive rate.}\label{fig:plot-tpr-fpr-sim}
\end{figure}
